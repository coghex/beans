...
getBinDir = catchIO (getEnv "beans_bindir") (\_ -> return bindir)
getLibDir = catchIO (getEnv "beans_libdir") (\_ -> return libdir)
getDataDir = catchIO (getEnv "beans_datadir") (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "beans_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "beans_sysconfdir") (\_ -> return sysconfdir)
