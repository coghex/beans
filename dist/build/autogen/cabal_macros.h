...
/* package beans-0.2.0.0 */
#define VERSION_beans "0.2.0.0"
#define MIN_VERSION_beans(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  2 || \
...
/* package kawhi-0.2.1 */
#define VERSION_kawhi "0.2.1"
#define MIN_VERSION_kawhi(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  2 || \
...
#define CURRENT_COMPONENT_ID "beans-0.2.0.0"

#define CURRENT_PACKAGE_KEY "beans-0.2.0.0"
